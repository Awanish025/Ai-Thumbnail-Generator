...
export default function Footer() {
    return (
        <footer className="flex bg-white/6 border-t border-white/10 flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-20 py-20 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
